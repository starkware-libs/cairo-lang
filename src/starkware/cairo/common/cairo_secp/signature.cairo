...
# Note:
#   Some places use the values 27 and 28 instead of 0 and 1 for v. In that case, a subtraction by 27
#   returns a v that can be used by this function.
# Prover assumptions:
...
func recover_public_key{range_check_ptr}(
