...
from starkware.cairo.stark_verifier.air.layouts.all_cairo.global_values import (
    CurveConfig,
    EcdsaSigConfig,
    EcPoint,
    GlobalValues,
...
from starkware.cairo.stark_verifier.air.layouts.all_cairo.periodic_columns import (
    eval_ecdsa_x,
    eval_ecdsa_y,
...
from starkware.cairo.stark_verifier.air.layouts.all_cairo.public_verify import segments
...
func traces_eval_composition_polynomial{range_check_ptr}(
    ...
    local global_values: GlobalValues = GlobalValues(
        ...
        initial_add_mod_addr=public_input.segments[segments.ADD_MOD].begin_addr,
        initial_mul_mod_addr=public_input.segments[segments.MUL_MOD].begin_addr,
