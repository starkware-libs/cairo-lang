...
COMPILER_DIR = get_build_dir_path("../cairo-compiler-archive-2.0.0")
...
if __name__ == "__main__":
    ...
    shutil.copytree(
        os.path.join(COMPILER_DIR, "bin"),
        os.path.join(dst_dir, "starkware/starknet/compiler/v1/bin"),
    )
    shutil.copytree(
        os.path.join(COMPILER_DIR, "corelib"),
        os.path.join(dst_dir, "starkware/starknet/compiler/v1/corelib"),
    )
