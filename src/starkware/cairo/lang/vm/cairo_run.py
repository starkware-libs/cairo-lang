...
def main():
    ...
    parser.add_argument(
        "--no_end", action="store_true", help="Don't check that the program ended successfully."
    )
    parser.add_argument(
        "--print_memory",
        action="store_true",
    ...
    parser.add_argument(
        "--print_segments", action="store_true", help="Print the segment relocation table."
    )
    parser.add_argument(
        "--print_output",
        action="store_true",
    ...
    parser.add_argument(
        "--layout", choices=LAYOUTS.keys(), default="plain", help="The layout of the Cairo AIR."
    )
