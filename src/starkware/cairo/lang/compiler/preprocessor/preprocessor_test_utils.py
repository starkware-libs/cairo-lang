...
def preprocess_str(
        code: str, prime: int, main_scope: Optional[ScopedName] = None,
...
def preprocess_str_ex(
        code: str, pass_manager: PassManager,
...
def verify_exception(
        ...
        exc_type=PreprocessorError, pass_manager: Optional[PassManager] = None):
    """
