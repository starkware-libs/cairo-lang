...
class GasCost(Enum):
    ...
    # Syscall cas costs.
    CALL_CONTRACT = 16 * RANGE_CHECK + 903 * STEP
    DEPLOY = 7 * PEDERSEN + 19 * RANGE_CHECK + 1173 * STEP
    DEPLOY_CALLDATA_FACTOR = 1 * PEDERSEN + 8 * STEP
    GET_BLOCK_HASH = 2 * RANGE_CHECK + 107 * STEP
    GET_CLASS_HASH_AT = 1 * SYSCALL_BASE
    GET_EXECUTION_INFO = 2 * RANGE_CHECK + 108 * STEP
    ...
    LIBRARY_CALL = 16 * RANGE_CHECK + 879 * STEP
    ...
    META_TX_V0 = 9 * PEDERSEN + 16 * RANGE_CHECK + 1275 * STEP
