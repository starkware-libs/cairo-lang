...
class GasCost(Enum):
    ...
    SECP256K1_GET_XY = 175 * STEP + 9 * RANGE_CHECK
    SECP256K1_MUL = 121956 * STEP + 10739 * RANGE_CHECK
    ...
    SECP256R1_GET_XY = 177 * STEP + 9 * RANGE_CHECK
    SECP256R1_MUL = 195595 * STEP + 21477 * RANGE_CHECK
