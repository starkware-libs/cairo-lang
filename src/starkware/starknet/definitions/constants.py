...
class GasCost(Enum):
    ...
    SECP256K1_ADD = SYSCALL_BASE + 254 * STEP + 29 * RANGE_CHECK
    SECP256K1_GET_POINT_FROM_X = SYSCALL_BASE + 260 * STEP + 30 * RANGE_CHECK
    SECP256K1_GET_XY = SYSCALL_BASE + 24 * STEP + 9 * RANGE_CHECK
    SECP256K1_MUL = SYSCALL_BASE + 121810 * STEP + 10739 * RANGE_CHECK
    SECP256K1_NEW = SYSCALL_BASE + 340 * STEP + 36 * RANGE_CHECK
