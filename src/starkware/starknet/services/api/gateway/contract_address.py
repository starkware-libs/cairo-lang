...
CONTRACT_ADDRESS_PREFIX = from_bytes("STARKNET_CONTRACT_ADDRESS".encode("ascii"))
...
def calculate_contract_address(
    ...
    return compute_hash_on_elements(
        data=[CONTRACT_ADDRESS_PREFIX, caller_address, salt, contract_hash], hash_func=hash_function
    )
