...
const SECP256K1_ADD_GAS_COST = SYSCALL_BASE_GAS_COST + 254 * STEP_GAS_COST + 29 *
    RANGE_CHECK_GAS_COST;
const SECP256K1_GET_POINT_FROM_X_GAS_COST = SYSCALL_BASE_GAS_COST + 260 * STEP_GAS_COST + 30 *
    RANGE_CHECK_GAS_COST;
const SECP256K1_GET_XY_GAS_COST = SYSCALL_BASE_GAS_COST + 24 * STEP_GAS_COST + 9 *
    RANGE_CHECK_GAS_COST;
const SECP256K1_MUL_GAS_COST = SYSCALL_BASE_GAS_COST + 121810 * STEP_GAS_COST + 10739 *
    RANGE_CHECK_GAS_COST;
const SECP256K1_NEW_GAS_COST = SYSCALL_BASE_GAS_COST + 340 * STEP_GAS_COST + 36 *
    RANGE_CHECK_GAS_COST;
